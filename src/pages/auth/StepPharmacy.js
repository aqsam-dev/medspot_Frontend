...
const GOOGLE_MAPS_API_KEY = process.env.REACT_APP_GOOGLE_MAPS_API_KEY || "AIzaSyDG8heyzoXFxdqbkt-Qy1PpOsm3IQ3ctjI";
const MAP_ID = "593aaf660a6f150a749bed3e";
        ...
        <form onSubmit={handleNext} style={{ padding: '0 10px 30px 10px' }}>
          <div className="form-grid">
            ...
            <div className="form-group" style={{ gridColumn: '1 / -1' }}>
              ...
              <APIProvider apiKey="AIzaSyDG8heyzoXFxdqbkt-Qy1PpOsm3IQ3ctjI">
